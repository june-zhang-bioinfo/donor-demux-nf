...
def main():
    ...
    parser.add_argument("--barcode_file", required=True, help="Path to the barcodes.tsv file.")
    ...
    barcode_path = args.barcode_file
    ...
    # --- 7. Save results ---
    posteriors.to_csv('demuxalot_posteriors.csv')
    likelihoods.to_csv('demuxalot_likelihoods.csv')
